...
public class FileProcessorInAction {
    ...
    public Documents parseAndValidatePnld(InputStream inStream) throws Exception {
        ...
        Schema schema = factory
                        .newSchema(new StreamSource(new FileInputStream(PNLD_XSD_SCHEMA_LOCATION)));
        ...
        try {
            ...
            throw new Exception(String.format("Error validating PNLD file %s against provided XSD",
                            file.getPublicId()));
        }
    ...
    private void readFromZip() throws Exception {
        ...
        while ((ze = zin.getNextEntry()) != null) {
            if (!ze.isDirectory()) {
                ...
                // System.out.write(c);
                // }
                Documents x = parseAndValidatePnld(zin);
